  ...
  \cvSection{Education}
    ...
    \cvSubsection{University of Bergen, Norway}
      \begin{cvTimeItem}{since Jun.~2022}{Master Thesis for M.Sc. Mathematics}
        \begin{cvItemize}
          \item Current working title \cvQuote{Design and Implementation of a High-Performance, Adaptive, and Robust Curve Smoothing Algorithm on Surface Meshes and its Application to Medical Visualization}
  ...
  \cvSection{Further Interests and Activities}
    ...
    \begin{multicols}{2}
      ...
      \begin{cvTimeItem}{Open-Source}{build2, build2-packaging}
        \begin{cvItemize}
          \item Voluntarily educating people, providing tools, and packaging third-party libraries for \cvQuote{build2}
        \end{cvItemize}
      \end{cvTimeItem}
